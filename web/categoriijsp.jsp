...
<html>
    ...
    <body>
        ...
        <%--<% int hidden = Integer.parseInt(request.getParameter("idStire"));%>--%>
            ...
            <div class="fright">
                <%!  String afisareTitluStiri(int id) throws IOException {
                        ...
                        for (PozeStiri ps : pozeStiri) {
                            ...
                            if (ps.getIdStire().getIdCategorie().getIdCategorie() == id && stireDejaAfisata[ps.getIdStire().getIdStire() - 1] == 0) {
                                {
...
//                                sb.append("</form>");
                                    sb.append("<a href=\"stirijsp.jsp?idStire=" + ps.getIdStire().getIdStire() + "\" style=\"text-decoration: none;color:black\"");     //"+ps.getIdStire().getIdStire());
                ...
                <% String url = request.getQueryString();
                 //System.out.println();
                    ...
                    int id = Integer.parseInt(url.substring(12));
