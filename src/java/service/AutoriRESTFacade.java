...
public class AutoriRESTFacade {
    ...
    public AutoriJpaController getJpaController() {
        try {
    ...
    public Response create(Autori entity) {
        try {
            ...
            return Response.created(URI.create(entity.getIdAutor().toString())).build();
        } catch (Exception ex) {
    ...
    public Autori find(@PathParam("id") Short id) {
